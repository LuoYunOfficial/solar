...
// Script from the end of the original index.html
let script = document.createElement('script');
script.src = "https://luoyunofficial.github.io/solar/assets/in.js"; // 没有这个脚本
...
newElement.innerHTML = "An error occurred when loading configurations, please try again later.";
